...
<div class="search_form">
    <form action="{{ route('search') }}" method="post">
        ...
        <button class="btn btn_search" type="submit">{{ __('search') }}</button>
    </form>
</div>
...
<table class="product_list">
    ...
    @foreach ($products as $products)
        <tr>
            ...
            <td><button type="button" class="btn btn_more"><a href="{{ route('more', $products -> product_id) }}">{{ __('more') }}</a></button></td>
